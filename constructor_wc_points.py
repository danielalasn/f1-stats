...
# plt.title(f'Constructors Championship after {circuit} GP {year} (Top {cant_constructors})')
plt.suptitle(f"Constructors Championship 2023 Season", size=25)
